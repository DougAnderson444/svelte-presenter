...
var app = (function () {
    ...
    function create_key_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 51, 3, 1355);
    		},
    		m: function mount(target, anchor) {
    ...
    // (48:0) <Carousel items={pages} {currentIndex} let:payload>
    function create_default_slot$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main_1, file$2, 49, 1, 1328);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(48:0) <Carousel items={pages} {currentIndex} let:payload>",
    		ctx
    	});
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(window, "keyup", /*handleKey*/ ctx[8], false, false, false),
    ...
    function get_each_context_1(ctx, list, i) {
    	...
    	child_ctx[7] = list[i].payload;
    	child_ctx[8] = list[i].select;
    	return child_ctx;
    }

    // (10:12) {#each tabs as { active, payload, select }}
    function create_each_block_1(ctx) {
    	let button;
    	let t_value = /*payload*/ ctx[7] + "";
    	let t;
    	let mounted;
    	let dispose;
    	...
    	const block = {
    		c: function create() {
    			...
    			toggle_class(button, "active", /*active*/ ctx[6]);
    			add_location(button, file$4, 10, 16, 280);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    			append_dev(button, t);
    			...
    			if (!mounted) {
    				dispose = listen_dev(
    					...
    					"click",
    					function () {
    						if (is_function(/*select*/ ctx[8])) /*select*/ ctx[8].apply(this, arguments);
    					},
    					false,
    					false,
    					false
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if (dirty & /*tabs*/ 32 && t_value !== (t_value = /*payload*/ ctx[7] + "")) set_data_dev(t, t_value);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(10:12) {#each tabs as { active, payload, select }}",
    		ctx
    	});
    ...
    // (9:8) <div class="tabs" slot="tabs" let:tabs>
    function create_tabs_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$4, 8, 8, 158);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(9:8) <div class=\\\"tabs\\\" slot=\\\"tabs\\\" let:tabs>",
    		ctx
    	});
    ...
    // (15:12) <TabControlItem {id} payload={`${component.name}.${component.type}`} active={id === 0}>
    function create_default_slot_1(ctx) {
    	...
    	function textarea_input_handler() {
    		/*textarea_input_handler*/ ctx[1].call(textarea, /*each_value*/ ctx[3], /*id*/ ctx[4]);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(textarea, file$4, 15, 16, 543);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, textarea, anchor);
    			set_input_value(textarea, /*component*/ ctx[2].source);
    			insert_dev(target, t, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(15:12) <TabControlItem {id} payload={`${component.name}.${component.type}`} active={id === 0}>",
    		ctx
    	});
    ...
    // (14:8) {#each components as component, id}
    function create_each_block$1(ctx) {
    	...
    	tabcontrolitem = new TabControlItem({
    			props: {
    				id: /*id*/ ctx[4],
    				payload: `${/*component*/ ctx[2].name}.${/*component*/ ctx[2].type}`,
    				active: /*id*/ ctx[4] === 0,
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*components*/ 1) tabcontrolitem_changes.payload = `${/*component*/ ctx[2].name}.${/*component*/ ctx[2].type}`;

    			if (dirty & /*$$scope, components*/ 2049) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(14:8) {#each components as component, id}",
    		ctx
    	});
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*$$scope, components, tabs*/ 2081) {
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ TabControl, TabControlItem, components });
    	...
    	return [components, textarea_input_handler];
    }
...
`;
    ...
    function create_default_slot$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$8, 10, 0, 336);
    		},
    		m: function mount(target, anchor) {
    ...
    const { layout, hue, sat, lum } = metadata;
...
npm run dev</code>` + "";
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$a, 10, 0, 333);
    			add_location(strong0, file$a, 11, 3, 361);
    			add_location(p0, file$a, 11, 0, 358);
    			add_location(p1, file$a, 12, 0, 395);
    			attr_dev(pre0, "class", "language-null");
    			add_location(pre0, file$a, 13, 0, 436);
    			add_location(p2, file$a, 14, 0, 574);
    			attr_dev(pre1, "class", "language-null");
    			add_location(pre1, file$a, 15, 0, 609);
    			add_location(strong1, file$a, 17, 3, 714);
    			add_location(p3, file$a, 17, 0, 711);
    			add_location(code, file$a, 18, 31, 778);
    			add_location(p4, file$a, 18, 0, 747);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h1, anchor);
    			insert_dev(target, t1, anchor);
    ...
    const { layout: layout$1, hue: hue$1, sat: sat$1, lum: lum$1 } = metadata$1;
    ...
    function create_default_slot$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$b, 10, 0, 337);
    			attr_dev(a0, "href", "https://www.svelte.dev");
    			attr_dev(a0, "rel", "nofollow");
    			add_location(a0, file$b, 11, 76, 449);
    			attr_dev(a1, "href", "https://www.mdsvex.com");
    			attr_dev(a1, "rel", "nofollow");
    			add_location(a1, file$b, 14, 16, 517);
    			add_location(p0, file$b, 11, 0, 373);
    			add_location(p1, file$b, 15, 0, 582);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h1, anchor);
    			insert_dev(target, t1, anchor);
    ...
    const { layout: layout$2, hue: hue$2, sat: sat$2, lum: lum$2 } = metadata$2;
    ...
    function create_default_slot$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$c, 10, 0, 333);
    			add_location(strong0, file$c, 11, 3, 358);
    			add_location(p0, file$c, 11, 0, 355);
    			add_location(code0, file$c, 13, 57, 450);
    			add_location(li0, file$c, 13, 0, 393);
    			add_location(code1, file$c, 14, 56, 536);
    			add_location(li1, file$c, 14, 0, 480);
    			add_location(li2, file$c, 15, 0, 564);
    			add_location(ul0, file$c, 12, 0, 388);
    			add_location(strong1, file$c, 17, 3, 650);
    			add_location(p1, file$c, 17, 0, 647);
    			add_location(li3, file$c, 19, 0, 688);
    			add_location(li4, file$c, 20, 0, 729);
    			add_location(li5, file$c, 21, 0, 791);
    			add_location(li6, file$c, 22, 0, 860);
    			add_location(ul1, file$c, 18, 0, 683);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h1, anchor);
    			insert_dev(target, t1, anchor);
    ...
    const { layout: layout$3, hue: hue$3, sat: sat$3, lum: lum$3 } = metadata$3;
    ...
    function create_default_slot$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$d, 10, 0, 337);
    			add_location(strong0, file$d, 11, 3, 357);
    			add_location(p0, file$d, 11, 0, 354);
    			add_location(li0, file$d, 13, 0, 416);
    			add_location(li1, file$d, 14, 0, 434);
    			add_location(li2, file$d, 15, 0, 450);
    			add_location(ul, file$d, 12, 0, 411);
    			add_location(strong1, file$d, 17, 3, 482);
    			add_location(p1, file$d, 17, 0, 479);
    			add_location(code, file$d, 18, 96, 623);
    			add_location(p2, file$d, 18, 0, 527);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h1, anchor);
    			insert_dev(target, t1, anchor);
    ...
    const { layout: layout$4, hue: hue$4, sat: sat$4, lum: lum$4 } = metadata$4;
...
&lt;/style&gt;</code>` + "";
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$g, 11, 0, 434);
    			add_location(li0, file$g, 13, 0, 469);
    			add_location(code0, file$g, 14, 22, 568);
    			add_location(li1, file$g, 14, 0, 546);
    			add_location(ul, file$g, 12, 0, 464);
    			add_location(code1, file$g, 16, 3, 655);
    			add_location(p, file$g, 16, 0, 652);
    			attr_dev(pre, "class", "language-svelte");
    			add_location(pre, file$g, 17, 0, 726);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h1, anchor);
    			insert_dev(target, t1, anchor);
    ...
    const { layout: layout$5, hue: hue$5, sat: sat$5, lum: lum$5 } = metadata$5;
...
&lt;Repl &#123;components&#125; /&gt;</code>` + "";
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$h, 10, 0, 333);
    			add_location(p0, file$h, 11, 0, 352);
    			attr_dev(pre, "class", "language-null");
    			add_location(pre, file$h, 12, 0, 409);
    			add_location(p1, file$h, 22, 0, 803);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h1, anchor);
    			insert_dev(target, t1, anchor);
    ...
    const { layout: layout$6, hue: hue$6, sat: sat$6, lum: lum$6 } = metadata$6;
...
<style>
    ...
    const { layout: layout$7, hue: hue$7, sat: sat$7, lum: lum$7 } = metadata$7;
