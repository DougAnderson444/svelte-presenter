...
var app = (function () {
    ...
    /* src\components\Navigation.svelte generated by Svelte v3.24.1 */
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button0, "class", "svelte-1kyvtm5");
    			add_location(button0, file, 55, 1, 1162);
    			attr_dev(span, "class", "svelte-1kyvtm5");
    			add_location(span, file, 56, 4, 1201);
    			attr_dev(button1, "class", "svelte-1kyvtm5");
    			add_location(button1, file, 57, 1, 1217);
    			attr_dev(div, "class", "svelte-1kyvtm5");
    			add_location(div, file, 54, 0, 1154);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(window, "keyup", /*handlekey*/ ctx[2], false, false, false),
    					listen_dev(button0, "click", /*prev*/ ctx[0], false, false, false),
    ...
    const file$1 = "src\\layouts\\Centered.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$1, 16, 4, 280);
    			attr_dev(div1, "class", div1_class_value = "page " + /*css*/ ctx[0] + " svelte-tlmxpa");
    			add_location(div1, file$1, 15, 0, 250);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Centered extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { css: 0 });
    ...
    const file$2 = "src\\pages\\01_Introduction.svx";
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$2, 10, 0, 264);
    			add_location(p, file$2, 11, 0, 290);
    		},
    		m: function mount(target, anchor) {
    ...
    const file$3 = "src\\layouts\\Default.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div0 = element("div");
    			if (default_slot) default_slot.c();
    			add_location(div0, file$3, 5, 1, 72);
    			attr_dev(div1, "class", div1_class_value = "page " + /*css*/ ctx[0]);
    			add_location(div1, file$3, 4, 0, 45);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Default extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { css: 0 });
    ...
    const file$4 = "src\\pages\\02_GettingStarted.svx";
    ...
    function create_default_slot$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p0, file$4, 7, 0, 160);
    			attr_dev(pre, "class", "language-bash");
    			add_location(pre, file$4, 8, 0, 203);
    			add_location(strong, file$4, 9, 52, 393);
    			attr_dev(a, "href", "http://www.mdsvex.com");
    			attr_dev(a, "rel", "nofollow");
    			add_location(a, file$4, 9, 98, 439);
    			add_location(p1, file$4, 9, 0, 341);
    			add_location(p2, file$4, 10, 0, 572);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h1, anchor);
    			insert_dev(target, t1, anchor);
    ...
    const file$5 = "src\\pages\\03_Navigation.svx";
...
<span class="token punctuation">&#125;</span></code>` + "";
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p0, file$5, 7, 0, 155);
    			add_location(h2, file$5, 8, 0, 400);
    			add_location(code0, file$5, 9, 53, 485);
    			add_location(p1, file$5, 9, 0, 432);
    			attr_dev(pre, "class", "language-css");
    			add_location(pre, file$5, 10, 0, 546);
    			add_location(code1, file$5, 15, 43, 1463);
    			add_location(code2, file$5, 15, 109, 1529);
    			add_location(code3, file$5, 15, 131, 1551);
    			add_location(p2, file$5, 15, 0, 1420);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h1, anchor);
    			insert_dev(target, t1, anchor);
    ...
    const file$6 = "src\\pages\\04_Layouts.svx";
    ...
    function create_default_slot$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p0, file$6, 7, 0, 152);
    			add_location(strong0, file$6, 9, 4, 206);
    			add_location(li0, file$6, 9, 0, 202);
    			add_location(strong1, file$6, 10, 4, 312);
    			add_location(li1, file$6, 10, 0, 308);
    			add_location(strong2, file$6, 11, 4, 412);
    			add_location(li2, file$6, 11, 0, 408);
    			add_location(ul, file$6, 8, 0, 197);
    			add_location(p1, file$6, 13, 0, 562);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h1, anchor);
    			insert_dev(target, t1, anchor);
    ...
    const file$7 = "src\\pages\\05_Default.svx";
    ...
    function create_default_slot$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$7, 6, 0, 135);
    			add_location(p0, file$7, 7, 0, 159);
    			add_location(em, file$7, 8, 54, 310);
    			add_location(p1, file$7, 8, 0, 256);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h1, anchor);
    			insert_dev(target, t1, anchor);
    ...
    const file$8 = "src\\pages\\06_Centered.svx";
...
---</code>` + "";
    	...
    	const block = {
    		c: function create() {
    			...
    			t3 = space();
    			pre = element("pre");
    			add_location(h1, file$8, 10, 0, 264);
    			add_location(p, file$8, 11, 0, 289);
    			attr_dev(pre, "class", "language-null");
    			add_location(pre, file$8, 12, 0, 365);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h1, anchor);
    			insert_dev(target, t1, anchor);
    ...
    const file$9 = "src\\layouts\\Paged.svelte";
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$9, 30, 0, 644);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$a = "src\\pages\\07_Paged.svx";
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>section</span><span class="token punctuation">></span></span></code>` + "";
    	...
    	const block = {
    		c: function create() {
    			...
    			t21 = space();
    			pre2 = element("pre");
    			add_location(h1, file$a, 11, 0, 268);
    			add_location(h20, file$a, 12, 0, 292);
    			add_location(p0, file$a, 13, 0, 313);
    			add_location(p1, file$a, 14, 0, 495);
    			attr_dev(pre0, "class", "language-null");
    			add_location(pre0, file$a, 15, 0, 553);
    			add_location(section0, file$a, 10, 0, 258);
    			add_location(h21, file$a, 20, 0, 678);
    			add_location(code0, file$a, 21, 71, 764);
    			add_location(p2, file$a, 21, 0, 693);
    			attr_dev(pre1, "class", "language-md");
    			add_location(pre1, file$a, 22, 0, 806);
    			add_location(section1, file$a, 19, 0, 668);
    			add_location(h22, file$a, 35, 0, 1564);
    			add_location(code1, file$a, 36, 30, 1616);
    			add_location(strong, file$a, 36, 3, 1589);
    			add_location(p3, file$a, 36, 0, 1586);
    			attr_dev(pre2, "class", "language-md");
    			add_location(pre2, file$a, 37, 0, 1774);
    			add_location(section2, file$a, 34, 0, 1554);
    		},
    		m: function mount(target, anchor) {
    ...
    const file$b = "src\\pages\\08_Classes.svx";
...
---</code>` + "";
    	...
    	const block = {
    		c: function create() {
    			...
    			t11 = text(" file.");
    			add_location(h1, file$b, 10, 0, 252);
    			add_location(code0, file$b, 11, 25, 305);
    			add_location(em, file$b, 11, 207, 487);
    			add_location(p0, file$b, 11, 0, 280);
    			attr_dev(pre, "class", "language-null");
    			add_location(pre, file$b, 12, 0, 557);
    			add_location(code1, file$b, 15, 54, 710);
    			add_location(p1, file$b, 15, 0, 656);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h1, anchor);
    			insert_dev(target, t1, anchor);
    ...
    function create_fragment$c(ctx) {
    	...
    	navigation.$on("next", /*next*/ ctx[1]);
    	navigation.$on("prev", /*prev*/ ctx[2]);
    ...
    function instance$c($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Navigation, pages, index, next, prev });
