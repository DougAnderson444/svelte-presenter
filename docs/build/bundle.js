...
---</code>` + "";
    ...
    /* src\pages\09_Automated.svx generated by Svelte v3.24.1 */
    const file$b = "src\\pages\\09_Automated.svx";
    ...
    function create_default_slot$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h1 = element("h1");
    			h1.textContent = "Automation";
    			t1 = space();
    			p = element("p");
    			p.textContent = "Currently the pages are picked up automatically by Rollup, when adding or removing a page however, you have to manually save another (already watched) file to trigger a new pickup.";
    			add_location(h1, file$b, 6, 0, 135);
    			add_location(p, file$b, 7, 0, 155);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h1, anchor);
    			insert_dev(target, t1, anchor);
    ...
    function instance$b($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<_09_Automated> was created with unknown prop '${key}'`);
    	});

    	let { $$slots = {}, $$scope } = $$props;
    	validate_slots("_09_Automated", $$slots, []);
    	$$self.$capture_state = () => ({ Layout_MDSVEX_DEFAULT: Default });
    	return [];
    }

    class _09_Automated extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$c, 56, 1, 1329);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);

    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*prev*/ ctx[3], false, false, false);
    				mounted = true;
    			}
    		},
    		p: noop,
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$c, 60, 1, 1436);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(60:0) {#if index !== pages.length - 1}",
    		ctx
    	});
    ...
    function create_fragment$c(ctx) {
    	...
    	let mounted;
    	let dispose;
    	var switch_value = /*pages*/ ctx[1][/*index*/ ctx[0]];
    	...
    	let if_block1 = /*index*/ ctx[0] !== /*pages*/ ctx[1].length - 1 && create_if_block(ctx);
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(window, "keyup", /*handlekey*/ ctx[4], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    			if (switch_value !== (switch_value = /*pages*/ ctx[1][/*index*/ ctx[0]])) {
    				if (switch_instance) {
    					group_outros();
    			...
    			if (/*index*/ ctx[0] !== /*pages*/ ctx[1].length - 1) {
    				if (if_block1) {
    ...
    function instance$c($$self, $$props, $$invalidate) {
    	const pages = [_01_Introduction, _02_GettingStarted, _03_Navigation, _04_Layouts, _05_Default, _06_Centered, _07_Paged, _08_Classes, _09_Automated];
    	let index = 0;
    	...
    	console.log("Sun Aug 09 2020 17:14:19 GMT+0200 (Central European Summer Time)");
    	const writable_props = [];
    	...
    	$$self.$capture_state = () => ({
    		Page0: _01_Introduction,
    		Page1: _02_GettingStarted,
    		Page2: _03_Navigation,
    		Page3: _04_Layouts,
    		Page4: _05_Default,
    		Page5: _06_Centered,
    		Page6: _07_Paged,
    	...
    	return [index, pages, next, prev, handlekey];
    }
